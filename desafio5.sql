...
(hrjobs.MAX_SALARY - hrjobs.MIN_SALARY) AS `Variação Salarial`,
ROUND((hrjobs.MIN_SALARY / 12), 2) AS `Média mínica mensal`,
ROUND((hrjobs.MAX_SALARY / 12), 2) AS `Média máxima mensal`

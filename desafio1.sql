...
SELECT hrc.COUNTRY_NAME AS País, IF(hrc.REGION_ID = (SELECT REGION_ID FROM hr.regions AS hrr WHERE hrr.REGION_NAME = "Europe"), "incluído", "não incluído") AS `Status Inclusão` FROM hr.countries AS hrc;

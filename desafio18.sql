-- 18 - Faça um relatório que mostra o histórico de cargos das pessoas empregadas, mostrando as datas de início e de saída,
-- assim como os anos que ela ficou nesse cargo
...
ROUND((DATEDIFF(hrjobhist.END_DATE, hrjobhist.START_DATE)/365), 2) AS `Anos trabalhados`

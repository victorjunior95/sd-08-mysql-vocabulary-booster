-- 15 - Crie uma procedure chamada buscar_media_por_cargo que recebe como parâmetro o nome de um cargo
-- e em retorno deve mostrar a média salarial de todas as pessoas que possuem esse cargo
-- 	Sua procedure deve retornar somente 01 coluna com o alias "Média salarial",

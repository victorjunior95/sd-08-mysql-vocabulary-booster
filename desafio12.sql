...
SELECT CONCAT(hremp.FIRST_NAME, ' ', hremp.LAST_NAME) AS `Nome completo funcionário 1`,
hremp.SALARY AS `Salário funcionário 1`,
hremp.PHONE_NUMBER AS `Telefone funcionário 1`,
CONCAT(hremp2.FIRST_NAME, ' ', hremp2.LAST_NAME) AS `Nome completo funcionário 2`,
